...
class ErrorSummary:
    ...
    def total_errors(self) -> int:
        ...
        return (self.false_positives + self.false_negatives + 
                self.localization_errors + self.classification_errors + 
...
class ErrorAnalyzer:
    ...
    def _classify_prediction(
        ...
        if (best_iou >= self.classification_iou_threshold and 
            prediction.class_id != best_gt.class_id):
        ...
        if (self.localization_iou_threshold <= best_iou < self.iou_threshold and
            prediction.class_id == best_gt.class_id):
